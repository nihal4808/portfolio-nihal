...
export function ProjectCard({ repo }: { repo: GitHubRepo }) {
    ...
    return (
        <div className="flex flex-col h-full bg-[#1e293b]/60 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden group hover:border-[#38bdf8]/50 transition-all duration-500 shadow-2xl relative">
            ...
            <div className="p-6 flex flex-col flex-grow relative z-10 -mt-10">
                <div className="flex items-center justify-between mb-4">
                    <div className="bg-[#38bdf8]/10 p-2.5 rounded-xl border border-[#38bdf8]/20 group-hover:glow-primary transition-all duration-500">
                        <FolderGit2 size={22} className="text-[#38bdf8]" />
                    </div>
                    <div className="flex gap-3">
                        <a href={repo.html_url} target="_blank" className="p-2.5 bg-white/5 rounded-full hover:bg-[#38bdf8]/20 text-slate-400 hover:text-white transition-all border border-white/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                        </a>
                        {repo.homepage && (
                            <a href={repo.homepage} target="_blank" className="p-2.5 bg-white/5 rounded-full hover:bg-[#22c55e]/20 text-slate-400 hover:text-[#22c55e] transition-all border border-white/10">
                                <Link size={18} />
                            </a>
                        )}
                    </div>
                ...
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#38bdf8] transition-colors duration-300 capitalize tracking-tight">
                    {repo.name.replace(/-/g, ' ')}
                </h3>
                ...
                <div className="space-y-4 mb-6 flex-grow">
                    ...
                    <div className="bg-slate-900/50 rounded-xl p-4 border border-white/5 group-hover:border-[#38bdf8]/20 transition-all duration-500">
                        <div className="text-[10px] font-bold text-[#38bdf8] uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
                        ...
                        <a href={`${repo.html_url}#readme`} target="_blank" className="text-[10px] text-[#38bdf8] font-bold hover:underline mt-2 inline-block uppercase tracking-wider">
                            View Full README →
                        </a>
                    </div>
                </div>
                ...
                {repo.language && (
                    <div className="flex items-center gap-2 mt-auto">
                        <span className="text-[10px] px-3 py-1 bg-[#22c55e]/10 text-[#22c55e] font-bold rounded-full border border-[#22c55e]/20 tracking-wider">
